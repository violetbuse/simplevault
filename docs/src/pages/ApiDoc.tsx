  ...
  "query": {
    ...
    "params": [
      ...
      { "type": "varchar", "value": "gold" }
              ...
              <p className="text-[var(--text-muted)] text-sm mb-4">
                To send SQL <code className="bg-black/30 px-1 rounded">NULL</code>, use <code className="bg-black/30 px-1 rounded">{`{"type":"null","value":null}`}</code>. That value binds as an untyped null for the statement (for example <code className="bg-black/30 px-1 rounded">$1::int</code> or inserts into nullable columns), not only for text parameters.
              </p>
              <p className="text-[var(--text-muted)] text-sm mb-4">
